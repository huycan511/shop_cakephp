<div id="content" class="col-sm-12" data-cate="<?php echo $id_cate;?>" data-session="<?php if(!$this->Session->read('id_user')){ echo 'no_session';}else{echo 'session';}?>">
  <div class="col-sm-12 selectdiv">
    ...
    $(".js-range-slider").ionRangeSlider({
      ...
      var dataproduct = $.parseJSON($.ajax({
            ...
            async: false,
            data: {
              id_cate: $('#content').attr('data-cate')}
      }).responseText);
      var mang;
      var test = 8;
      ...
      var input = $('<input>').val(dataproduct).attr({
        ...
        mang = dataproduct;
      //   var li = $('<li>').addClass('page-item').appendTo($(ul));
      //   var a = $('<a>').addClass('page-link').text('1').appendTo($(li));
      //   var li1 = $('<li>').addClass('page-item').appendTo($(ul));
      //   var a1 = $('<a>').addClass('page-link').text('2').appendTo($(li1));
      ...
      function pagni(obj){
        ...
        $('#content').contents(':not(.selectdiv)').remove();
          for (var i = 8*obj.attr('data-currentpage'); i <8*obj.attr('data-currentpage')+8; i++) {
            if(i<mang.length){
              var div = $('<div>').attr({
            class: 'col-md-3 col-xs-6 khoisp',
            style: 'height: 300px;margin-bottom: 10px;cursor: pointer;overflow: hidden;'
          }).appendTo($('#content'));
          var a = $('<a>').attr({
            href: location.protocol + "//" + document.domain + "/home/product/"+mang[i]['id'],
          }).appendTo($(div));
          var _1sp = $('<div>').attr({
            class:'1sp',
            style: 'position: relative;width: 100%;height: 85%;',
          ...
          var img_link = mang[i]['image'].split(',')[1];
          var img = $('<img>').attr({
            src: '<?php echo FIELD;?>/app/webroot/img/product/'+img_link,
            style:'width:100%;height:100%;max-width: 100%;position: absolute;top:0;right: 0;'
          }).appendTo($(_1sp));
        ...
        var h4 = $('<h4>').attr({
          style: 'display: block; width: 100%;height: 50%;margin: 0;padding-top: 2px;'
        }).text(mang[i]['name']).appendTo($(divtt));
        var h4_2 = $('<h4>').attr({
          style: 'display: block; width: 50%;height: 50%;margin: 0;padding: 0;float:right;'
        }).addClass('text-right').text(numberWithCommas(mang[i]['price'])+'đ').appendTo($(divtt));
        var div_rate = $('<div>').css({
          width: '50%',
          height:'50%',
          margin:'0',
      ...
      $('#search_price').click(function(event) {
        ...
        $('#content').contents(':not(.selectdiv)').remove();
          ...
          var a = $('<a>').attr({
            href: location.protocol + "//" + document.domain + "/home/product/"+filter[i]['id'],
          }).appendTo($(div));
          var _1sp = $('<div>').attr({
            class:'1sp',
            style: 'position: relative;width: 100%;height: 85%;',
          ...
          var img_link = filter[i]['image'].split(',')[1];
          var img = $('<img>').attr({
            src: '<?php echo FIELD;?>/app/webroot/img/product/'+img_link,
            style:'width:100%;height:100%;max-width: 100%;position: absolute;top:0;right: 0;'
          }).appendTo($(_1sp));
        ...
        var h4 = $('<h4>').attr({
          style: 'display: block; width: 100%;height: 50%;margin: 0;padding-top: 2px;'
        }).text(filter[i]['name']).appendTo($(divtt));
        var h4_2 = $('<h4>').attr({
          style: 'display: block; width: 50%;height: 50%;margin: 0;padding: 0;float:right;'
        }).addClass('text-right').text(numberWithCommas(filter[i]['price'])+'đ').appendTo($(divtt));
        var div_rate = $('<div>').css({
          width: '50%',
          height:'50%',
          margin:'0',
