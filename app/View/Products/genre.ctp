  ...
  <div class="col-sm-12 selectdiv">
    ...
    $(".js-range-slider").ionRangeSlider({
      ...
      for (var i = 0; i < num; i++) {
        ...
        var h4_2 = $('<h4>').attr({
          style: 'display: block; width: 100%;height: 50%;margin: 0;padding: 0;'
        }).text(numberWithCommas(dataproduct[i]['price'])+'đ').appendTo($(divtt));
      }
      ...
      function pagni(obj){
        ...
        var h4_2 = $('<h4>').attr({
          style: 'display: block; width: 100%;height: 50%;margin: 0;padding: 0;'
        }).text(numberWithCommas(mang[i]['price'])+'đ').appendTo($(divtt));
            }
        }
      }
      $('#search_price').click(function(event) {
        ...
        var h4_2 = $('<h4>').attr({
          style: 'display: block; width: 100%;height: 50%;margin: 0;padding: 0;'
        }).text(numberWithCommas(filter[i]['price'])+'đ').appendTo($(divtt));
        }
        var pagnition = $('<div>').attr({
          class: 'col-sm-12 text-right'
        }).insertAfter($('#content'));
