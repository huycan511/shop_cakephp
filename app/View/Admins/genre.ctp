        ...
        <tbody id="table_cate">
            <?php for ($i=0; $i < count($genres); $i++) {?>
                <tr>
                    ...
                    <td><a class="edit" onclick="edit_genre_btn($(this))"><i class="fas fa-edit"></i></a><a class="d-none" data-id="<?php echo $genres[$i]['Genre']['id']?>" onclick="submit_edit_genre($(this))"><i class="fas fa-check"></i></a></td>
