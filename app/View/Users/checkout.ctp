						...
						<div class="col-sm-9">
							<table style="width:100%">
								<tr>
									...
									<td>
										<h3><?php echo $user['name'] ?></h3><input id="checkout_name" type="text" value="<?php echo $user['name'] ?>" class="form-control d-none">
									</td>
								...
								<tr>
									...
									<td>
										<h3><?php echo $user['phone'] ?></h3><input id="checkout_phone" value="<?php echo $user['phone'] ?>" type="text" class="form-control d-none">
									</td>
				...
				<div class="panel-body">
					...
					<div class="buttons">
						<div class="pull-right">
							<input type="button" data-user=<?php echo $this->Session->read('id_user') ?> data-loading-text="Loading..." class="btn btn-primary" onclick='confirmOrderFunc(<?php echo json_encode($array_id_cart); ?>,<?php echo json_encode($array_cart_amount);?>)' value="Confirm Order">
						</div>
					</div>
				</div>
			</div>
