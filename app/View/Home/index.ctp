    ...
    <div id="content" class="col-sm-12">
        ...
        <div id="tab-latest" class="tab-content">
          <div class="box">
            <div id="latest-slidertab" class="row owl-carousel product-slider">
              <?php for ($i=0,$max = count($products);$i < $max; $i++) { $img = explode(",", $products[$i]['Product']['image']); ?>
              <div class="item">
                <div class="product-thumb transition">
                  <div class="image product-imageblock"> <a href="home/product/<?php echo $products[$i]['Product']['id']?>"><img src="app/webroot/img/product/<?php echo $img[0]?>" class="img-responsive" /> </a>
                    <div class="button-group">
                      <button type="button" class="wishlist <?php if($this->Session->read('id_user')){echo 'like_product';}?>" data-product="<?php echo $products[$i]['Product']['id'] ?>" data-toggle="tooltip" title="Add to Wish List" ><i class="fas fa-heart" style="color: white;"></i></button>
                      <button type="button" data-izimodal-open="<?php if(!$this->Session->read('id_user')){
              echo "#modal-custom";
          } ?>" class="addtocart-btn" onclick="<?php if($this->Session->read('id_user')){echo 'addcart($(this))';}?>" data-user="<?php echo $this->Session->read('id_user') ?>" data-product="<?php echo $products[$i]['Product']['id'] ?>">Add To Cart</button>
                    </div>
                  </div>
        ...
        <div id="tab-special" class="tab-content">
          <div class="box">
            <div id="special-slidertab" class="row owl-carousel product-slider">
              <?php if(isset($like)){ for ($i=0,$max=count($like); $i < $max ; $i++) {?>
              <div class="item">
                <div class="product-thumb transition">
                  <div class="image product-imageblock"> <a href="home/product/<?php echo $like[$i]['productt']['id']?>"><img src="app/webroot/img/product/<?php $img=explode(",",$like[$i]['productt']['image'] ); echo $img[0]?>" class="img-responsive" /> </a>
                    <div class="button-group">
              ...
              echo "#modal-custom";
          } ?>" onclick="<?php if($this->Session->read('id_user')){echo 'addcart($(this))';}?>" data-user="<?php echo $this->Session->read('id_user') ?>" data-product="<?php echo $like[$i]['productt']['id'] ?>">Add To Cart</button>
                    </div>
                  </div>
                  <div class="caption product-detail">
        ...
        <div class="box">
          <div id="Weekly-slider" class="row owl-carousel product-slider">
            ...
            <div class="item product-slider-item">
              <div class="product-thumb transition">
                <div class="image product-imageblock"> <a href="home/product/<?php echo $categories[1]['genree'][$i]['productt'][$j]['id']?>"> <img src="app/webroot/img/product/<?php $img=explode(",",$categories[1]['genree'][$i]['productt'][$j]['image']);echo $img[0] ?>" class="img-responsive" /> </a>
                  <div class="button-group">
                    <button type="button" class="wishlist <?php if($this->Session->read('id_user')){echo 'like_product';}?>" data-product="<?php echo $categories[1]['genree'][$i]['productt'][$j]['id'] ?>" data-toggle="tooltip" title="Add to Wish List" ><i class="fas fa-heart" style="color: white;"></i></button>
                    <button type="button" data-izimodal-open="<?php if(!$this->Session->read('id_user')){
              echo "#modal-custom";
          } ?>" class="addtocart-btn" onclick="<?php if($this->Session->read('id_user')){echo 'addcart($(this))';}?>" data-user="<?php echo $this->Session->read('id_user') ?>" data-product="<?php echo $categories[1]['genree'][$i]['productt'][$j]['id'] ?>" >Add To Cart</button>
                  </div>
                </div>
                <div class="caption product-detail">
      ...
      <div class="box">
        <div id="feature-slider" class="row owl-carousel product-slider">
          ...
          <div class="item product-slider-item">
            <div class="product-thumb transition">
              <div class="image product-imageblock"> <a href="home/product/<?php echo $categories[0]['genree'][$i]['productt'][$j]['id']?>"> <img src="app/webroot/img/product/<?php $img=explode(",",$categories[0]['genree'][$i]['productt'][$j]['image']);echo $img[0] ?>" class="img-responsive" /> </a>
                <div class="button-group">
                  <button type="button" class="wishlist <?php if($this->Session->read('id_user')){echo 'like_product';}?>" data-product="<?php echo $categories[0]['genree'][$i]['productt'][$j]['id'] ?>" data-toggle="tooltip" title="Add to Wish List" ><i class="fas fa-heart" style="color: white;"></i></button>
                  <button type="button" data-izimodal-open="<?php if(!$this->Session->read('id_user')){
              echo "#modal-custom";
          } ?>" class="addtocart-btn" onclick="<?php if($this->Session->read('id_user')){echo 'addcart($(this))';}?>" data-user="<?php echo $this->Session->read('id_user') ?>" data-product="<?php echo $categories[0]['genree'][$i]['productt'][$j]['id'] ?>" >Add To Cart</button>
                </div>
              </div>
              <div class="caption product-detail">
            ...
            <li class="item blog-slider-item">
              <div class="panel-default">
                ...
                <div class="blog-content"> <a href="news/detail/<?php echo $news[$i]['News']['id']?>" class="blog-name">
                  ...
                  <a href="/news/detail/<?php echo $news[$i]['News']['id']?>" class="blog-readmore">Read More</a> <span class="blog-date">06/07/2015</span> </div>
              </div>
            </li>
          <?php }?>
          </ul>
